  ...
  return (
    <div className='group relative w-full border border-teal-500 hover:border-2 h-[400px] overflow-hidden rounded-lg sm:w-[400px] transition-all'>
      ...
      <div className='p-3 flex flex-col gap-2'>
        ...
        <Link href={`/post/${post.slug}`} passHref>
          <a className='z-10 group-hover:bottom-0 absolute bottom-[-200px] left-0 right-0 border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white transition-all duration-300 text-center py-2 rounded-3xl m-2'>
            Read article
          </a>
        </Link>
      </div>
